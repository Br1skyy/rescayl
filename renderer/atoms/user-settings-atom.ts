...
export const preserveFilenameAtom = atomWithStorage<boolean>(
  "preserveFilename",
  false,
);

export type BgRemovalMode = "off" | "before" | "after";

export const bgRemovalModeAtom = atomWithStorage<BgRemovalMode>(
  "bgRemovalMode",
  "off",
);

export const bgRemovalModelAtom = atomWithStorage<string>(
  "bgRemovalModel",
  "u2netp",
);

export const themeAtom = atomWithStorage<string>("theme", "rescayl");
